...
lib.ssMetadata = [
		{name:"lfrs_atlas_1", frames: [[0,339,854,378],[856,376,223,35],[856,339,249,35],[856,413,221,35],[0,719,729,70],[731,719,137,200],[0,0,1280,337]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.frame}]}).to({state:[{t:this.frame_1}]},17).to({state:[{t:this.frame_2}]},9).to({state:[{t:this.frame_3}]},10).to({state:[{t:this.frame_4}]},23).to({state:[{t:this.frame_5}]},28).to({state:[{t:this.frame_6}]},28).to({state:[{t:this.frame_7}]},24).to({state:[{t:this.frame_8}]},25).to({state:[{t:this.frame_9}]},25).to({state:[{t:this.frame_10}]},25).to({state:[{t:this.frame_11}]},25).to({state:[{t:this.frame_12}]},28).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(22.25,-207.85,1.4099,1.4099,0,0,0,10,10);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({_off:true},21).wait(19).to({_off:false,x:-369.85},0).wait(21));
	...
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.lf(["#666666","#999999"],[0,1],-79.7,0,79.8,0).s().p("AjIf2QBMvjhMv0QhAwJA/wLIGQAAQhGQHBHQFQBCQAhCPfg");
	...
	this.shape_21.graphics.lf(["#666666","#999999"],[0,1],-70.3,0,70.4,0).s().p("AjIf2QBfvhhfv2QhQwJBPwLIGQAAQhYQHBZQFQBTQFhTPag");
	...
	this.shape_29.graphics.lf(["#666666","#999999"],[0,1],-51.4,0,51.5,0).s().p("AjJf2QCGvdiGv6QhvwJBvwLIGQAAQh8QHB8QFQB1QMh1PTg");
	...
	this.shape_37.graphics.lf(["#666666","#999999"],[0,1],-32.5,0,32.6,0).s().p("AjJf2QCsvYisv/QiPwJCPwLIGQAAQigQHCgQFQCWQViWPKg");
	...
	this.shape_43.graphics.lf(["#666666","#999999"],[0,1],-27,0,27,0).s().p("AjJf2QCkvZikv+QiIwJCIwLIGQAAQiYQHCYQFQCOQTiOPMg");
	...
	this.shape_51.graphics.lf(["#666666","#999999"],[0,1],-25.4,0,25.5,0).s().p("AjJf2QB/vdh/v6QhqwJBqwLIGQAAQh2QHB2QFQBvQLhvPUg");
	...
	this.shape_57.graphics.lf(["#666666","#999999"],[0,1],-24.3,0,24.3,0).s().p("AjIf2QBkvhhkv2QhUwJBTwLIGQAAQhcQHBdQFQBXQFhXPag");
	...
	this.shape_65.graphics.lf(["#666666","#999999"],[0,1],-22.8,0,22.7,0).s().p("AjIf2QA/vlg/vyQg1wJA0wLIGQAAQg6QHA7QFQA3P+g3Phg");
	...
	this.shape_71.graphics.lf(["#666666","#999999"],[0,1],-21.6,0,21.7,0).s().p("AjIf2QAlvnglvwQgewJAewLIGQAAQgiQHAiQFQAgP3ggPog");
	...
	this.shape_84.graphics.lf(["#666666","#999999"],[0,1],-21.2,0,21.2,0).s().p("AjKf2QgTvsATvrQAawJgawLIGQAAQAcQHgcQFQgVPwAVPvg");
	...
	this.shape_86.graphics.lf(["#666666","#999999"],[0,1],-21.6,0,21.7,0).s().p("AjKf2QgavsAavrQAiwJgjwLIGQAAQAmQHglQFQgdPwAdPvg");
	...
	this.shape_132.graphics.lf(["#666666","#999999"],[0,1],-22.4,0,22.5,0).s().p("AjJf2QgtvsAtvrQA0v9g1wXIGQAAQA1QMg0QAQgvPwAvPvg");
	...
	this.shape_134.graphics.lf(["#666666","#999999"],[0,1],-22.8,0,22.9,0).s().p("AjJf2Qg1vsA1vrQA9v7g+wZIGQAAQA9QNg8P/Qg2PwA2Pvg");
	...
	this.shape_138.graphics.lf(["#666666","#999999"],[0,1],-23.7,0,23.7,0).s().p("AjKf2QhDvsBDvrQBPv3hPwdIGQAAQBOQPhOP9QhFPwBFPvg");
	...
	this.shape_144.graphics.lf(["#666666","#999999"],[0,1],-24.9,0,24.9,0).s().p("AjLf2QhZvsBZvrQBpvyhpwiIGQAAQBoQRhoP7QhcPwBcPvg");
	...
	this.shape_148.graphics.lf(["#666666","#999999"],[0,1],-25.6,0,25.7,0).s().p("AjMf2QhovsBovrQB7vth7wnIGQAAQB5QTh5P5QhsPwBsPvg");
	...
	this.shape_218.graphics.lf(["#666666","#999999"],[0,1],-23.7,0,23.7,0).s().p("AjGf2QBOvihOv1QhMwJBMwLIGQAAQhWQHBWQFQBGPwhGPvg");
	...
	this.shape_240.graphics.lf(["#666666","#999999"],[0,1],0,-20.7,0.1,20.8).s().p("A/3DJQgSi/ASjRQQGAKQGgKQPvgLPvALQAdDXgdC5QvtgLvqALQoEAEoFAAQoFAAoFgEg");
	...
	this.shape_266.graphics.lf(["#666666","#999999"],[0,1],-0.2,-26.8,0.3,26.9).s().p("EggdADOQj1hGD1lKQP/CTQOiTQPuiUPvCUQGWGfmWgPQwJiZvMCZQoJA/oFAAQoFAAoCg/g");
	...
	this.shape_288.graphics.lf(["#666666","#999999"],[0,1],-0.2,-27,0.3,27.1).s().p("EggbADOQjphNDplDQP/CLQOiLQPuiNPvCNQGDGUmDgEQwHiRvOCRQoJA7oFAAQoFAAoCg7g");
	...
	this.shape_290.graphics.lf(["#666666","#999999"],[0,1],-0.2,-26.6,0.2,26.7).s().p("EggYADNQjYhVDYk7QP/CBQOiBQPuiCPvCCQFnGGlnAKQwGiGvQCGQoIA4oFAAQoFAAoCg4g");
	...
	this.shape_298.graphics.lf(["#666666","#999999"],[0,1],-0.1,-25.2,0.2,25.3).s().p("EggNADMQiWh5CWkXQQCBZQLhZQPuhbPvBbQD4FLj4BFQv9hdvaBdQoGAmoFAAQoFAAoDgmg");
	...
	this.shape_308.graphics.lf(["#666666","#999999"],[0,1],0.1,-23.4,0.1,23.5).s().p("EggAADKQhCilBCjrQQFAoQHgoQPwgoPuAoQBvEChvCOQvygqvkAqQoFARoFAAQoFAAoFgRg");
	...
	this.shape_312.graphics.lf(["#666666","#999999"],[0,1],0.1,-22.7,0,22.8).s().p("A/6DJQghi2AhjaQQGAUQGgUQPvgUPvAUQA3Dlg3CrQvvgUvnAUQoFAJoFAAQoFAAoFgJg");
	...
	this.shape_317.graphics.lf(["#666666","#999999"],[0,1],0.2,-22.5,0,22.6).s().p("AAfDIQwJgKwLAKIAAmQQQHgIQFAIQPxAKPtgKIAAGQQn1AFn2AAQn1AAn2gFg");
	...
	this.shape_327.graphics.lf(["#666666","#999999"],[0,1],0.2,-25.1,0,25.2).s().p("AAfDDQwHg9wNA9IAAmQQQHgvQFAvQP4A8Pmg8IAAGQQn1Ain2AAQn1AAn2gig");
	...
	this.shape_355.graphics.lf(["#666666","#999999"],[0,1],0.2,-32.2,-0.1,32.3).s().p("AAfC4QwAjMwUDMIAAmQQQHieQFCeQQKDIPUjIIAAGQQn1Bwn2AAQn1AAn2hwg");
	this.shape_355.setTransform(-177.45,-205.5021);

	this.shape_356 = new cjs.Shape();
	this.shape_356.graphics.lf(["#666666","#999999"],[0,1],0.2,-32.1,-0.1,32.2).s().p("AAfC4QwAjBwUDBIAAmQQQHiWQFCWQQJC+PVi+IAAGQQn1Bsn2AAQn1AAn2hsg");
	...
	this.shape_363.graphics.lf(["#666666","#999999"],[0,1],0.2,-31.8,-0.1,31.9).s().p("AAfC+QwEh6wQB6IAAmQQQHhfQFBfQQAB4Peh4IAAGQQn1BEn2AAQn1AAn2hEg");
	...
	this.shape_375.graphics.lf(["#666666","#999999"],[0,1],0.2,-31.4,-0.1,31.4).s().p("AAfDJMggUAAAIAAmRMAgMAAAIfeAAIAAGRg");
...
p.nominalBounds = new cjs.Rectangle(-90.5,-251.6,448.7,516.4);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape_122 = new cjs.Shape();
	this.shape_122.graphics.f().s("#000000").ss(1.1,1,1).p("");
...
if (reversed == null) { reversed = false; }
	...
	this.bf.name = "bf";
	this.bf.setTransform(285.6,0.85,0.6292,0.6292,0,0,0,62.6,161);

	this.timeline.addTween(cjs.Tween.get(this.bf).to({regY:161.1,skewX:3.9995,x:303.05,y:2.05},19).to({regY:161,skewX:0,x:285.6,y:0.85},20).to({regY:161.1,skewX:-3.9995,x:268.1,y:1.6},20).to({regY:161,skewX:0,x:285.6,y:0.85},20).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(78.9,-251.5,413.5,504.1);
...
if (reversed == null) { reversed = false; }
	...
	this.animCtrl_Btn.setTransform(456.05,356.05,1,1,0,0,0,0,0.1);
	...
	this.shape.setTransform(274.125,343.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#7D7D7E").ss(4,1,1).p("EgnGAAAMBONAAA");
	this.shape_1.setTransform(273.275,322.75);
	...
	this.shearwall.setTransform(431.9,230.5,1,1,0,0,0,55.9,92.5);

	this.instance_2 = new lib.CachedBmp_349();
	this.instance_2.setTransform(377.35,324.85,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_348();
	this.instance_3.setTransform(212.65,324.85,0.5,0.5);

	this.bracedframe = new lib.bracedFrame();
	this.bracedframe.name = "bracedframe";
	this.bracedframe.setTransform(275.1,276.05,0.3657,0.3657,0,0,0,285.8,126);

	this.instance_4 = new lib.CachedBmp_347();
	this.instance_4.setTransform(61.9,324.85,0.5,0.5);

	this.momentframe = new lib.momentframe_1();
	this.momentframe.name = "momentframe";
	this.momentframe.setTransform(172.6,273.45,0.3657,0.3657,0,0,0,285.8,125.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.momentframe},{t:this.instance_4},{t:this.bracedframe},{t:this.instance_3},{t:this.instance_2},{t:this.shearwall}]}).wait(1));

	// Layer_5
	this.instance_5 = new lib.CachedBmp_350();
	this.instance_5.setTransform(60.9,135.6,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(287,201.9,238.60000000000002,165.79999999999998);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/lfrs_atlas_1.png?1639046876700", id:"lfrs_atlas_1"}
	],
	preloads: []
};
