...
lib.ssMetadata = [
		{name:"appliedforces_atlas_1", frames: [[692,411,187,41],[0,411,467,41],[469,411,221,41],[0,339,729,70],[0,0,1280,337]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape_120.graphics.f().s("#000000").ss(1.1,1,1).p("");
...
if (reversed == null) { reversed = false; }
	...
	this.animCtrl_Btn.setTransform(456.05,370.75,1,1,0,0,0,0,0.1);
	new cjs.ButtonHelper(this.animCtrl_Btn, 0, 1, 2, false, new lib.StartBtn(), 3);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#7D7D7E").ss(4,1,1).p("EgnGAAAMBONAAA");
	this.shape.setTransform(273.275,357.75);
	...
	this.instance_2.setTransform(424.3,229.45,0.5,0.5);

	this.shearwall = new lib.shearwall();
	this.shearwall.name = "shearwall";
	this.shearwall.setTransform(423.25,346.5,0.2595,0.2596,0,0,0,-178.8,-43.4);

	this.instance_3 = new lib.CachedBmp_89();
	this.instance_3.setTransform(163.4,229.45,0.5,0.5);

	this.bracedframe = new lib.bracedFrame();
	this.bracedframe.name = "bracedframe";
	this.bracedframe.setTransform(281.15,305,0.4122,0.4122,0,0,0,285.7,125.9);

	this.instance_4 = new lib.CachedBmp_88();
	this.instance_4.setTransform(31.95,229.45,0.5,0.5);

	this.momentframe = new lib.momentframe_1();
	this.momentframe.name = "momentframe";
	this.momentframe.setTransform(149.15,306.95,0.4122,0.4122,0,0,0,285.7,125.8);
...
p.nominalBounds = new cjs.Rectangle(287,201.9,238.60000000000002,180.49999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/appliedforces_atlas_1.png?1638446428816", id:"appliedforces_atlas_1"}
	],
	preloads: []
};
